//   __  __ _                            __ _      _____
//  |  \/  (_)_ __   ___  ___ _ __ __ _ / _| |_   |_   _|__   ___  ___
//  | |\/| | | '_ \ / _ \/ __| '__/ _` | |_| __|____| |/ _ \ / _ \/ __|
//  | |  | | | | | |  __/ (__| | | (_| |  _| ||_____| | (_) | (_) \__ \
//  |_|  |_|_|_| |_|\___|\___|_|  \__,_|_|  \__|    |_|\___/ \___/|___/
//
#include <bits/stdc++.h>
#include <windows.h>
#include <wininet.h>
...
int main(){
    ...
    while (!isLoggedIn && attempts < maxAttempts) {
        ...
        if (username == "User" && password == "12345678") {
            ...
            attempts++;
            std::string message =
    "用户不存在或密码错误，剩余尝试次数：" +   // 窄字符串字面量
    std::to_string(maxAttempts - attempts);
            MessageBoxA(
    NULL,
    message.c_str(),
    "Minecraft-Toos",  // 窄字符串标题
    MB_OK|MB_ICONHAND);
    ...
    if (!isLoggedIn) {
        MessageBoxW(NULL,L"密码尝试次数已用完，Minecraft-Toos即将退出……",L"Minecraft-Toos",MB_OK|MB_ICONASTERISK);
        return 1;
    }
    system("cls");
    while(true){
        ...
        cout<<"\n==============================================\n运行时:C++21      minGW版本：14.0    cmake版本：4.0.1\n编译器版本：Jetbrains Clion 2025.1.1     当前版本：6.4.2正式版\n==============================================\n\n";
        ...
        case 5:
            ...
            system("cls");
            cout<<"====================\n百宝箱\n======================\n";
            cout<<"[1]当前时间 [2]闪瞎你的勾眼 [3]返回 [4]new hands攻略(新手攻略)  [5]计算器  [6]代码彩蛋 [7]数字炸弹 [8]游戏内时间转换器...(欢迎大家投稿,作者是个C++新手但我会尽量开发的！！！)\n enter your numbers:";
            int c;
            cin>>c;
            switch (c) {
                case 1: {
                ...
                case 2: {
                    system("cls");
                    cout<<"食用提示：本功能不适用于有光瘫病患者和眼睛有问题的选手\n[1]继续  [2]返回\n enter your numbers:";
                    int f;
                    cin>>f;
                    switch (f) {
                        case 1: {
